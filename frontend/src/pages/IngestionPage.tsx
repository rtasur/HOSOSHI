...
import { Search, Plus, Upload, Database, ClipboardCheck, X } from 'lucide-react';
    ...
    <div>
      ...
      <div className="ingestion-grid">
        ...
        <section className="panel">
          ...
          <label>File<input type="file" accept=".pdf,.csv,.xlsx,.xls,.docx,.txt,.json,.png,.jpg,.jpeg" onChange={(event) => setFile(event.target.files?.[0])} /></label>
